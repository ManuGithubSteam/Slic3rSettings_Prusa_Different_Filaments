...
| After curing| Food safe,0.20|||
|0.15|||
| 0.10|
|Colorfabb nGen LUX|nGen Material|||
| Very sprakly in direct sunlight|||
|Very strong interlayer adhesion,0.25|||
|0.20|||
| 0.15|||
| 0.10|
...
| RECALIBRATE Z!!!,0.20|||
| 0.15|
|Colorfabb NGEN|nGen Material| low shrinkage| no warping|||
|Very strong interlayer adhesion|||
| Glossy finish| Tg of 85| bonds well with ApolloX,0.25|||
|0.20|||
|0.15|||
|0.10|
|Colorfabb XT CF20|||
...
|Colorfabb BROZEFILL|||
|Colorfabb GLOWFILL|Green Glow at Night. Needs high infill for best glow|||
|Very abrasive (more than CF!)| use Steelnozzle|||
|Glows for +9 months|Needs to be charged with strong light source,0.25|||
|0.20|||
|0.15|||
|0.10|||
|0.07 beta|
|Colorfabb HT|A bit Hydrophile| Temp resistant to 100 degrees|||
|Super mechanical performance|greater toughness than XT|||
|Super strong| nearly see trough| enclousure advised|||
|FDA approved = Food safe,0.25|||
|0.20|||
|0.15|||
|0.10 beta|||
|0.07 beta|
...
|Colorfabb Corkfill|||
|Colorfabb WoodFill|Wood like structure| very light parts| very bright wood color|||
|30% recycled woodfibres| PLA/PHA + fine pinewood fibres|||
|Easy sanded|Good with wood filler and wood stain|||
|Very soft filament| after sanding very woodlike,0.25|||
|0.20|||
|0.15|||
|0.10|||
|0.07 beta|
...
|Proto-pasta Magnetic Iron PLA|Filament that is feromagnetic| Filament that can RUST|||
|PLA base,0.30|||
|0.25|||
|0.20|||
|0.15|||
|0.10 beta|
|feelcolor Kanova materic Marble|k/canova mineral stone material|porous for sanding and coloring|||
|Suitable for modeling like plaster/soap stone with knife|||
|More perimters advised| GLUESTICK needed!|,0.20|||
|0.15|||
|0.10|||
|0.07 beta|
|Lay Filaments Lay-Felt Poro-Lay|Expermimental filament!| gets soft when submerged in water|||
|Felt like feel| ||
|Lay Filaments MoldLay|Wax like filament| for lost mold casting|||
|Gets water liquid at 275 degrees| let cool down the print!|||
|Prints molds for permanent casting and for lost-wax casting.,0.25|||
|0.20|||
|0.15 beta|
|EUMAKERS PLA Glow Blue|The favourite blue glowing PLA from  Eumakers<br>|0.30|||
|0.25|||
|0.20|||
|0.15|||
|0.10|
...
|DruckerRihno Marble PLA|PLA with Marlble effect is actually hard to come by. |||
|It actually looks like marble,0.30|||
|0.25|||
|0.20|||
|0.15|||
|0.10|||
|0.007|
|Eryone Silk Blue PLA|PLA with a Silk feel and very shiny. |||
|Hides layers well with 1.5 or less.,0.30|||
|0.25|||
|0.20|||
|0.15|||
|0.12|||
|0.10|||
|0.007|
|Copper 3D PLACTIVE AN1 Antimicrobial Filament|NASA tested| kills 99.99% of fungi| viruses| bacteria|||
| And a wide range of microorganisms. Can be thermoformed|||
|Good layer adhesion| FDA approved| A bit stringy,0.30|||
|0.25|||
|0.20|||
|0.15|||
|0.10|
